...
-- サンプル助成金テンプレートを挿入
INSERT OR IGNORE INTO subsidy_templates (subsidy_name, category, document_templates, checklist_items) VALUES
('雇用調整助成金', '雇用維持', 
 '["休業実施計画書テンプレート.docx", "雇用調整実施状況報告書.xlsx", "休業協定書ひな形.docx"]',
 '["労使協定の締結", "休業実施計画の作成", "休業手当の支払い", "支給申請書の提出", "実施報告書の作成"]'),
('キャリアアップ助成金', '人材育成',
 '["キャリアアップ計画書.docx", "正社員転換報告書.xlsx", "処遇改善計画書.docx"]',
 '["キャリアアップ計画の作成", "労働局への計画提出", "正社員転換の実施", "処遇改善の実施", "支給申請"]'),
('IT導入補助金', 'DX推進',
 '["IT導入計画書テンプレート.xlsx", "効果測定報告書.docx", "導入ツール一覧表.xlsx"]',
 '["IT導入支援事業者の選定", "導入計画の策定", "交付申請", "ITツールの導入", "事業実施効果報告"]');
