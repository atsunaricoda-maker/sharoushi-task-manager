    ...
    async function editSubsidy(subsidyId) {
      try {
        ...
        if (response.data.success) {
          ...
          document.getElementById('subsidyId').value = subsidy.id;
          document.getElementById('name').value = subsidy.name || '';
          document.getElementById('category').value = subsidy.category || '';
          document.getElementById('managing_organization').value = subsidy.managing_organization || '';
          document.getElementById('description').value = subsidy.description || '';
          document.getElementById('max_amount').value = subsidy.max_amount || '';
          document.getElementById('subsidy_rate').value = subsidy.subsidy_rate || '';
          document.getElementById('application_period_type').value = subsidy.application_period_type || 'anytime';
          document.getElementById('application_start_date').value = subsidy.application_start_date || '';
          document.getElementById('application_end_date').value = subsidy.application_end_date || '';
          document.getElementById('url').value = subsidy.url || '';
          document.getElementById('requirements').value = subsidy.requirements || '';
          document.getElementById('required_documents').value = subsidy.required_documents || '';
